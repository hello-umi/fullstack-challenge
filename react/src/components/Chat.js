...
/**
 * Remember to use your own bot sharing url. You can get it from the
 * Bot > Share > Share with a link.
 */
const botUrl =
  'https://chats.landbot.io/u/H-441480-B0Q96FP58V53BJ2J/index.html';
...
export default function Chat() {
  ...
  useEffect(() => {
    ...
    fetch(fixConfigUrl(botUrl), {
      ...
      .then((res) => res.json())
      .then((remoteConfig) => {
        core.setConfig(remoteConfig);
        return core.init().then((data) => {
